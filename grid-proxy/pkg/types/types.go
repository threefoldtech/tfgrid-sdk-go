...
type Node struct {
	...
	GridVersion       int          `json:"gridVersion" sort:"grid_version"`
	...
	Status            string       `json:"status" sort:"status:` // added node status field for up or down
	CertificationType string       `json:"certificationType"`
