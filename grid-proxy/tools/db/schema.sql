...
--
-- Name: generic_contract; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.generic_contract (
    id character varying NOT NULL,
    grid_version integer NOT NULL,
    contract_id numeric NOT NULL,
    twin_id integer NOT NULL,
...
ALTER TABLE public.generic_contract OWNER TO postgres;
--
...
CREATE TABLE public.nodes_cache(
    id character varying NOT NULL,
    node_id integer NOT NULL,
    ...
    free_cru numeric NOT NULL,
    renter integer,
    rent_contract_id numeric,
    node_contracts integer NOT NULL,
    farm_id integer NOT NULL,
    dedicated_farm bool NOT NULL,
    free_gpus integer NOT NULL
);
ALTER TABLE public.nodes_cache OWNER TO postgres;
--
-- Name: farms_cache
--

CREATE TABLE public.farms_cache(
    id character varying NOT NULL,
    farm_id integer NOT NULL,
...
ALTER TABLE public.farms_cache OWNER TO postgres;
--
