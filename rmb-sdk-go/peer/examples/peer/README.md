...
This is a `Go` example for the `RMB` [direct client](https://github.com/threefoldtech/zos_sdk_go/blob/development/rmb-sdk-go/peer/README.md#direct-client) that can send `RMB` messages through connecting to the relay directly.
