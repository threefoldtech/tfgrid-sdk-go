...
This is a `Go` example for the `RMB` [rpc client](https://github.com/threefoldtech/zos_sdk_go/blob/development/rmb-sdk-go/peer/rpc.go) that can send `RMB` messages through working with rmb-peer and a redis server.
