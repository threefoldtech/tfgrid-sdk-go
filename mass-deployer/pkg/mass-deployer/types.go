...
type NodesGroup struct {
	...
	FreeCPU    uint64 `yaml:"free_cpu" validate:"nonzero" json:"free_cpu"`
	FreeMRU    uint64 `yaml:"free_mru" validate:"nonzero" json:"free_mru"`
	...
	PublicIP4  bool   `yaml:"public_ip4" json:"pubip4"`
	PublicIP6  bool   `yaml:"public_ip6" json:"pubip6"`
