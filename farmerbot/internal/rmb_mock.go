...
func (m *MockRMB) ListGPUs(ctx context.Context, nodeTwin uint32) ([]gpu, error) {
	m.ctrl.T.Helper()
...
func (m *MockRMB) Statistics(ctx context.Context, nodeTwin uint32) (zosResourcesStatistics, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Statistics", ctx, nodeTwin)
	ret0, _ := ret[0].(zosResourcesStatistics)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
