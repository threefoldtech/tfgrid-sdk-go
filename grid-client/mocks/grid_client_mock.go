...
func (m *MockClient) Contract(contractID uint32) (types.Contract, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Contract", contractID)
...
func (mr *MockClientMockRecorder) Contract(contractID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Contract", reflect.TypeOf((*MockClient)(nil).Contract), contractID)
}

// ContractBills mocks base method.
func (m *MockClient) ContractBills(contractID uint32, limit types.Limit) ([]types.ContractBilling, uint, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ContractBills", contractID, limit)
...
func (mr *MockClientMockRecorder) ContractBills(contractID, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ContractBills", reflect.TypeOf((*MockClient)(nil).ContractBills), contractID, limit)
}
